...
export default function LoginScreen() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-4 bg-background px-6">
      ...
      <Text className="text-xl font-semibold text-foreground">BatataFlix</Text>
      ...
      <View className="w-full max-w-sm gap-3">
        ...
        <Pressable
          onPress={entrar}
          disabled={entrando}
          className="items-center rounded-md bg-accent py-3 disabled:opacity-50"
        >
          <Text className="font-medium text-white">{entrando ? "Entrando..." : "Entrar"}</Text>
        </Pressable>
      </View>
    </View>
  );
